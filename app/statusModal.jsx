          ...
          <TouchableWithoutFeedback>
            <View style={styles.modalBox}>
              ...
              <Image
                ...
                style={styles.icon}
              />
              <Text style={styles.title}>Are you sure you want to set your status to "has arrived"?</Text>
              <Text style={styles.text}>
                Setting your status to active will let people on queue know that you have arrived at the terminal</Text>
